...
export class LoginDriverController{
    constructor(readonly loginDriverUseCase: LoginDriverUseCase){}
    ...
    async login(req: Request, res: Response){
        try {
            ...
            const loginDriver = await this.loginDriverUseCase.login(email,password);

            if(loginDriver === 'Unauthorized'){
