...
class UpdateNoteUseCase {
    ...
    update(uuid, title, description) {
        return __awaiter(this, void 0, void 0, function* () {
            let data = new note_1.ValidatorUpdate(uuid, title, description);
            const validation = yield (0, class_validator_1.validate)(data);
            if (validation.length > 0) {
                throw new Error(JSON.stringify(validation));
            }
            try {
                const updateNote = yield this.noteRepository.updateNote(uuid, title, description);
                return updateNote;
            }
            catch (error) {
                return null;
