...
exports.GetWeekAmountByUserUseCase = void 0;
const class_validator_1 = require("class-validator");
const weeklyAmount_1 = require("../domain/validations/weeklyAmount");
class GetWeekAmountByUserUseCase {
    ...
    get(user_uuid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const getWeeklyByUser = yield this.weekly_amountRepository.getWeeklyAmountByUser(user_uuid);
...
exports.GetWeekAmountByUserUseCase = GetWeekAmountByUserUseCase;
//# sourceMappingURL=getWeeklyAmountByUserUseCase.js.map