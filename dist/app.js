...
const driver_vehicleRoutes_1 = require("./driver-vehicle/infraestructure/driver-vehicleRoutes");
admin.initializeApp({
...
app.use('/api/v1/driver_vehicles', driver_vehicleRoutes_1.driver_vehicleRoutes);
