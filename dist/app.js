...
const weekly_amountRouter_1 = require("./weekly_amount/infraestructure/weekly_amountRouter");
admin.initializeApp({
...
app.use('/api/v1/weeklyAmount', weekly_amountRouter_1.weeklyAmountRoutes);
