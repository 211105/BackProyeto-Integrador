...
class CreateExpenseUseCase {
    ...
    post(weekly_amount_uuid, category, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            const miuuid = (0, uuid_1.v4)();
            let data = new expense_1.ValidatorCreate(miuuid, weekly_amount_uuid, category, amount);
            const validation = yield (0, class_validator_1.validate)(data);
            if (validation.length > 0) {
                throw new Error(JSON.stringify(validation));
            }
            try {
                const createExpense = yield this.expenseRepository.createExpense(miuuid, weekly_amount_uuid, category, amount);
