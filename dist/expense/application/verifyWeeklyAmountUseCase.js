...
class VerifyWeeklyAmountUseCase {
    ...
    get(weekly_amount_uuid, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            let data = new expense_1.ValidatorupdateAmount(weekly_amount_uuid, amount);
            const validation = yield (0, class_validator_1.validate)(data);
            if (validation.length > 0) {
                throw new Error(JSON.stringify(validation));
            }
            try {
                const verifyWeeklyAmount = yield this.expenseRepository.verifyWeeklyAmount(weekly_amount_uuid, amount);
