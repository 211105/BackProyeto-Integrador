...
const getUserOwnersUseCase_1 = require("../application/getUserOwnersUseCase");
const getUserOwnersController_1 = require("./controllers/getUserOwnersController");
...
exports.getUserOwnersUseCase = new getUserOwnersUseCase_1.GetUserOwnersUseCase(exports.mysqlUserRepository);
exports.getUserOwnersControllers = new getUserOwnersController_1.GetUserOwnersControllers(exports.getUserOwnersUseCase);
